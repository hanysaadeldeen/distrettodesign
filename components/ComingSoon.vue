<template>
  <main class="relative py-10 flex justify-center items-center md:py-20 h-screen">
    <div class="container mx-auto relative z-30">
      <div class="relative flex flex-col items-center justify-center">
        <div class="relative mb-10  w-[200px]">
          <img src="~/assets/img/Logo.svg" alt="Logo" class="h-ful w-full object-contain" width="200" height="200" />
        </div>
        <div class="w-full md:max-w-[992px] mb-8 ">
          <h1 class="mb-6 text-center text-4xl font-semibold text-white  md:text-8xl md:!leading-[84px]">
            Coming Soon
          </h1>

        </div>
        <div class="relative mx-auto flex w-full max-w-[1110px] flex-wrap justify-center gap-7 text-center md:gap-14">
      ...
      <div class="mt-10 flex flex-wrap items-center justify-center gap-6">
        <div class="overflow-hidden" v-for="social in socialMedia" :key="social.altText">
          <a :href="social.link">
            <img :src="social.icon" :alt="social.altText" class="h-ful w-full object-contain max-w-11 max-h-11"
              width="32" height="32" />
          </a>
        </div>
      </div>
      <div class="flex flex-col items-center justify-center mt-8">
        ...
        <span class="text-sm font-normal text-white text-center mx-auto inline-block w-fit">Copyright 2025
          distrettodesign. All
          Rights
          Reserved.
          Powered <a href="https://do.com.sa/" target="_blank" class="font-bold text-white text-base">
            DO</a> ©</span>
      </div>
    </div>
  </main>
